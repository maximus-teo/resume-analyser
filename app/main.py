...
async def analyse(
    ...
    (score, keyword_score, resume_sections, section_scores, density, matched_keywords, missing_keywords, semantic_score) = get_weighted_score(resume_text, job_text, jobdesc_category)
